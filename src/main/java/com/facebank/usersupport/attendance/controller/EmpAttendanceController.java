...
public class EmpAttendanceController extends BaseController {
    ...
    @ResponseBody
    public RestModel getAttendanceRecord(GetAttendanceForm attendanceForm,String draw){
        try {
    ...
    public void output(HttpServletResponse response,GetAttendanceForm attendanceForm) throws Exception {
