...
public class CapitalController extends BaseController {
    ...
    @RequestMapping("/money/getMoneyRecordPage")
    public RestModel getMoneyRecord(String mobile, String type, Long starttime, Long endtime, Integer pageSize, Integer pageNumber)  {
        ...
        Date time2 = TimeUtil.LongToDate(endtime,format);
        try{
            PageInfo<MoneyRecord> pageinfos = iCapitalService.getMoneyRecord(mobile,type,time1,time2,pageSize,pageNumber);
