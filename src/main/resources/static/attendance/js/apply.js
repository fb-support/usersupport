$(document).ready(function () {
    ...
    window.document.getElementById("datetimeEnd").value = 2018-04-09 ;
...
//     userId = id;
//     // $('#detailForm').getElementsByTagName('input').attr("readonly",true);
//     // $('#detailForm').getElementsByTagName('textarea').attr("readonly",true);
//     $('#showDetail').modal();
//     // $.ajax({
//     //     type: "GET",
//     //     url: '',//'/um/getByUserId?userId=' + id,
