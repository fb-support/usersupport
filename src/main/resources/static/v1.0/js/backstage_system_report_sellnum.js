window.onload=function() {
	...
	$.ajax({
		type : "POST", //请求方式  
		url : url+"/forms/sellnumformsOf7Day.do", //请求路径 
		cache : false,
		dataType : 'json', //返回值类型 
		success : function(msg) {
		    ...
		    // 指定图表的配置项和数据
		    var option = window.parent.getOptionOfSellNum( msg.legend, msg.category, msg.data1, msg.data2, msg.data3, 1);
